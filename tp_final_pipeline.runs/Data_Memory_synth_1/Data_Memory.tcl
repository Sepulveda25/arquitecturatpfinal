...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir {E:/Facultad/Arquitectura de Computadoras/Practicos Vivado/tp_final_pipeline/tp_final_pipeline.runs/Data_Memory_synth_1} -new_name Data_Memory -ip [get_ips Data_Memory]]

if { $cached_ip eq {} } {

synth_design -top Data_Memory -part xc7a35tcpg236-1 -mode out_of_context
